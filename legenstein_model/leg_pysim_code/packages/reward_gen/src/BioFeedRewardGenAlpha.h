#ifndef BIOFEEDREWARDGENALPHA_H_
#define BIOFEEDREWARDGENALPHA_H_

#include "SimObject.h"
#include "SpikeSender.h"
#include "SpikeBuffer.h"

class BioFeedRewardGenAlpha : public SimObject, public SingleOutputSpikeSender
{
    SIMOBJECT( BioFeedRewardGenAlpha, AdvancePhase::One )
public:

    BioFeedRewardGenAlpha(float Apos = 1,
                     float Aneg = -1,
                     float taupos = 40e-3,
                     float tauneg = 40e-3,
                     float Gap = 2e-3, 
...
#endif /*BIOFEEDREWARDGENALPHA_H_*/
